...
export default function PublicProfile() {
  ...
  const { posts, fetchPublicPosts } = usePosts();
  ...
  if (loadingProfile) {
    return <div className="min-h-screen flex items-center justify-center font-bold text-2xl text-slate-500">Loading Profile...</div>;
  }
